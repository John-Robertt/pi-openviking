...
function normalizeType(value) {
  // pi emits camelCase roles ("toolResult", "toolCall") while the other
  // harnesses this module serves use snake_case. Without splitting camel
  // boundaries first, pi's tool results normalise to "toolresult", match no
  // known role, and get dropped from capture entirely — the tool output never
  // reaches OpenViking and is lost once the context boundary advances.
  return String(value || "")
